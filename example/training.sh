...
do
python ../reactIDR/score_converter.py --merge --output vitro_${suffix} 2_${suffix}.bed.tab,3_${suffix}.bed.tab 0_${suffix}.bed.tab,1_${suffix}.bed.tab
python ../reactIDR/score_converter.py --merge --output vivo_${suffix} 4_${suffix}.bed.tab,5_${suffix}.bed.tab 0_${suffix}.bed.tab,1_${suffix}.bed.tab
done
...
do
    echo writing to ${PATTERN}_${cond}.csv >&2
    python ../reactIDR/IDR_hmm.py --idr --case ${cond}_ctss_case.tab --cont ${cond}_ctss_cont.tab --core 5 --param ${cond}_train.param.txt --output ${cond}.csv --ref rRNA_with_minus.fa --${PATTERN} > ${PATTERN}_${cond}.out.txt
done
...
do
    echo writing to ${PATTERN}_${cond}.csv >&2
    python ../reactIDR/IDR_hmm.py --idr --case ${cond}_ctss_case.tab --cont ${cond}_ctss_cont.tab --core 5 --param default_parameters.txt --output ${cond}.csv --ref rRNA_with_minus.fa --${PATTERN} > ${PATTERN}_${cond}.out.txt
done
...
python ../reactIDR/plot_bargraph.py --ignore --idr --output vivo_vitro --bed output --threshold 0.1 --segment test_vivo_all.csv  test_vitro_all.csv 
